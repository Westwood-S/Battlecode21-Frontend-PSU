...
class Account extends Component {
	...
	render() {
		...
		let button = (
			<button disabled style={{ float: "right" }} onClick={this.uploadResume} className={btn_class}>
				{" "}
				Upload{" "}
			</button>
		);
		if (this.state.selectedFile !== null) {
			...
			button = (
				<button style={{ float: "right" }} onClick={this.uploadResume} className={btn_class}>
					{" "}
					Upload{" "}
				</button>
			);
		...
		if (this.state.user.verified === false) {
			resume_status = <label style={{ float: "right" }}> You have not uploaded a resume.</label>;
		} else {
			resume_status = (
											...
											<div className="col-md-12">
												<div className="form-group">
														...
														content={
															<div>
																<p>
																	...
																	<a href="http://battlecode.org/#sponsors-sponsors">sponsors</a>. In the past, sponsors
																	have offered our competitors opprotunities based of their resumes and performance in
																	Battlecode!
																</p>
															</div>
														}
													...
													<label htmlFor="file_upload">
														...
														<span style={{ textTransform: "none", marginLeft: "10px", fontSize: "14px" }}>
															{" "}
															{file_label}{" "}
														</span>
													</label>
