                        ...
                        <div className="col-md-12">
                                ...
                                <p>
                                    ...
                                    <ul>
                                        ...
                                        <ul>
                                            ...
                                            <li>For Windows, try following <a target="_blank" rel="noopener noreferrer" href="https://www.theserverside.com/feature/How-to-set-JAVA_HOME-in-Windows-and-echo-the-result" style={{fontWeight:700}}>these instructions</a>.</li>
                                            <li>Try setting <code>org.gradle.java.home=/path_to_jdk_1.8_directory</code>. You need to know your <code>JAVA_HOME</code> (try <a target="_blank" rel="noopener noreferrer" href='https://www.baeldung.com/find-java-home' style={{fontWeight:700}}>this guide</a>).</li>
                                        </ul>
                                        </li>
                            ...
                            <div className="card">
                                ...
                                <p>
                                    ...
                                    need to refresh dependencies. Right-click on the project name (most likely <code>battlecode21-scaffold</code>) in the Gradle Tool Window (the right-hand sidebar),
                            ...
                            <div className="card">
                                ...
                                <p>
                                    <ul>
									    <li>Did you set your <code>JAVA_HOME</code> correctly? (Most common mistake. You have to manually set your <code>JAVA_HOME</code> environment variable to direct to the <code>PATH</code> of your downloaded JDK.)</li>
                                        ...
                                        <li>Redownload <a target="_blank" rel="noopener noreferrer" href="https://github.com/battlecode/battlecode21-scaffold" style={{fontWeight:700}}>the scaffold</a>.</li>
                                    </ul>
                                </p>
                                </div>
                            </div>
