	...
	render() {
		return (
			<div className="content">
				<div id="pixi"></div>
				<Slider
					style={{ display: this.v == null ? "none" : "block", width: "100%" }}
					max={this.state.numTurns}
					onChange={this.changeSlider}
					value={this.state.turn}
				/>
				<button style={{ display: this.v == null ? "none" : "block" }} onClick={this.startStop}>
					START/STOP
				</button>
				<Slider
					style={{ display: this.v == null ? "none" : "block", width: "200px" }}
					max={200}
					onChange={this.changeSpeed}
					value={this.state.extraWait}
				/>
				<div id="dropzonehej" style={{ display: this.v == null ? "block" : "none" }}>
