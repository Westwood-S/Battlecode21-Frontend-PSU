			...
			<div className="col-md-12">
				<div className="card">
					...
					<div className="content">
						...
						<button type="button" className="btn btn-info btn-fill pull-right" onClick={this.createTeam}>
							Create
						</button>
						<div className="clearfix" />
					</div>
				...
				<div className="card">
					...
					<div className="content">
						...
						<button type="button" className="btn btn-info btn-fill pull-right" onClick={this.joinTeam}>
							Join
						</button>
						<div className="clearfix" />
					</div>
