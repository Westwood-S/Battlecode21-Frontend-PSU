			...
			<div className="col-md-12">
				<div className="card">
					<div className="header">
						...
						<br />
						<div>
							If you're using <b>Chrome</b> with <b>MacOS</b>, after downloading the replay, you should use terminal to{" "}
							<code>unzip nameofthezip.zip</code>. Simply double clicking to unzip might cause file extesion lost. (This
							is a problem with mac.) Or you can just use <b>safari</b>.
						</div>
					</div>
											...
											<td>
												...
												<Floater
													content={
														<div>
															<p>
																Our server has run into an error running this scrimmage. Don't worry, we're working on
																resolving it!
															</p>
											...
											{s.REPLAY === "ready" ? (
												<td>
													...
													<button
														...
														onClick={() => this.onSubFileRequest(s.DATESTORE, s.ROBOTA, s.ROBOTB, s.MAP)}
													>
														Download
													</button>{" "}
												</td>
